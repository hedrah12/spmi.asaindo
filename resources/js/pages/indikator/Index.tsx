...
export default function IndikatorIndex({ data, filters }) {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (isEditMode && selectedId) {
            router.put(`/indikator/${selectedId}`, formData, {
                onSuccess: () => closeModal(),
            });
        } else {
            router.post("/indikator", formData, {
                onSuccess: () => closeModal(),
            });
        }
    };
    ...
    const handleEdit = (item: any) => {
        ...
        setFormData({
            namaIndikator: item.pernyataan_indikator, // Sesuai kolom DB
        });
    };
                        ...
                        <DialogContent className="sm:max-w-[630px]">
                            ...
                            <form onSubmit={handleSubmit} className="grid gap-6 py-4">
                                <div className="grid grid-cols-4 items-center gap-4">
                                    <Label htmlFor="namaIndikator" className="text-right">
                                    ...
                                    <Input
                                        ...
                                        className="col-span-3 h-35" // Tinggi input lebih besar karena teks panjang
                                        placeholder="Contoh: Dokumen visi misi tersedia..."
                                        required
                                    />
                                </div>
                            ...
                            {data.length === 0 ? (
                                ...
                                data.map((item, index) => (
                                    <tr key={item.id} className="border-t">
                                        ...
                                        <td className="p-4 text-justify">{item.pernyataan_indikator}</td>
