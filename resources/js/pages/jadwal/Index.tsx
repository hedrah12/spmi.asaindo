...
import {
    ...
    HelpCircle, AlertTriangle, Printer, Lock // [UPDATE] Import Lock Icon
} from "lucide-react";
                                                ...
                                                <tr key={item.id_jadwal} className="group hover:bg-slate-50 dark:hover:bg-slate-900/50 transition-colors duration-200">
                                                    <td className="p-5 align-top">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            {/* [UPDATE] Badge Terkunci */}
                                                            {item.is_graded && (
                                                                <Badge variant="secondary" className="text-[10px] bg-amber-100 text-amber-700 border-amber-200 gap-1 px-1.5">
                                                    ...
                                                    <td className="p-5 align-top text-center">
                                                        <div className="flex items-center justify-center gap-2">
                                                            ...
                                                            {/* [UPDATE] Tombol Edit (Disabled jika Terkunci) */}
                                                            <Button
                                                                size="icon"
                                                                variant="ghost"
                                                                className={`h-8 w-8 ${item.is_graded
                                                                    ? 'text-gray-300 cursor-not-allowed opacity-50'
                                                                    : 'text-orange-600 hover:text-orange-700 hover:bg-orange-50 dark:hover:bg-orange-900/30'
                                                                    }`}
                                                                disabled={item.is_graded}
                                                                onClick={() => !item.is_graded && handleEdit(item)}
                                                                title={item.is_graded ? "Jadwal sudah dinilai (Tidak bisa diedit)" : "Edit"}
                                                            >
                                                                {item.is_graded ? <Lock size={16} /> : <Edit size={16} />}
                                                            </Button>

                                                            {/* [UPDATE] Tombol Hapus (Disabled jika Terkunci) */}
                                                            <Button
                                                                size="icon"
                                                                variant="ghost"
                                                                className={`h-8 w-8 ${item.is_graded
                                                                ...
                                                                disabled={item.is_graded}
                                                                onClick={() => !item.is_graded && onDeleteClick(item.id_jadwal)}
                                                                title={item.is_graded ? "Jadwal sudah dinilai (Tidak bisa dihapus)" : "Hapus"}
                                                            >
                                                                {item.is_graded ? <Lock size={16} /> : <Trash2 size={16} />}
                                                            </Button>
                                                        </div>
                                                    </td>
                                                </tr>
                    ...
                    <DialogContent className="sm:max-w-[425px] bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700">
                        <DialogHeader>
                            <DialogTitle className={`flex items-center gap-2 ${helpDialog.type === "danger" ? "text-red-600" : "text-indigo-600"}`}>
                                {helpDialog.type === "danger" ? <AlertTriangle size={20} /> : <HelpCircle size={20} />}
                                {helpDialog.title}
                            </DialogTitle>
                        ...
                        <DialogFooter className="gap-2 sm:gap-0">
                            <Button variant="outline" onClick={() => setHelpDialog(prev => ({ ...prev, isOpen: false }))}>Batal</Button>
                            <Button
                                ...
                                className={helpDialog.type === "info" ? "bg-indigo-600 hover:bg-indigo-700" : ""}
                            >
                                Ya, Lanjutkan
                            </Button>
                        </DialogFooter>
