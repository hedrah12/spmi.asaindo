...
interface User {
  ...
  // Tambahkan definisi departemen sesuai struktur database
  departemens: {
              ...
              >
                ...
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div className="space-y-1">
                    ...
                    {/* --- AREA ROLES & DEPARTEMEN --- */}
                    <div className="flex flex-col gap-2 mt-2">
                        {/* Menampilkan Roles */}
                        {user.roles.length > 0 && (
                        <div className="flex flex-wrap gap-1 items-center">
                            <span className="text-[10px] uppercase text-muted-foreground font-bold mr-1">Role:</span>
                            {user.roles.map((role) => (
                        ...
                        {/* 2. MENAMPILKAN DEPARTEMEN */}
                        {user.departemens && user.departemens.length > 0 && (
                        <div className="flex flex-wrap gap-1 items-center">
                             <span className="text-[10px] uppercase text-muted-foreground font-bold mr-1">Dept:</span>
                             {user.departemens.map((dept) => (
                                // Menggunakan variant="outline" agar beda visual dengan Role
                                <Badge key={dept.id_departemen} variant="outline" className="text-xs font-normal border-blue-200 text-blue-700 bg-blue-50">
